...
- [x] Partilha via link sem autenticação
...
| `publico.php` | Visualização pública (sem login) |
...
- Cores da organização são definidas pelo superadmin e propagam automaticamente para editor, ver, pdf e link público
